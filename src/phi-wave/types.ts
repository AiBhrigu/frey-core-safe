...
export interface SyncEvent {
  /** Event type */
  type: 'tick' | 'phase-reset' | 'frequency-change' | 'layer-update' | 'q7-wave' | 'pattern:update' | 'emergent:update' | 'memory:update' | 'resonance:update' | 'coherence:update' | 'modulation:update' | 'phase:update' | 'entropy:update' | 'global:update';
  /** Event timestamp */
  timestamp: number;
  /** Event data */
